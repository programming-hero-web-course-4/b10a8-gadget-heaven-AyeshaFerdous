    ...
    <div className="bg-[#9538E2] text-white pb-64 rounded-bl-3xl rounded-br-3xl relative">
      <div className="hero-content text-center">
        <div className="max-w-2xl">
          ...
          <button className="btn text-[#9538E2] bg-white rounded-full"><NavLink to={'/dashboard'}>Shop Now</NavLink> </button>
        </div>
      </div>
    </div>

    <div className='absolute -bottom-[24.75rem] left-[11.25rem] z-10 border p-4 rounded-3xl bg-white/30 backdrop-blur-xl mb-10'>
